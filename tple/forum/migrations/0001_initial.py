...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'forum_forumpost', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'forumposts', to=orm['auth.User'])),
        ))
        ...
        db.create_unique(m2m_table_name, ['forumpost_id', 'blogcategory_id'])
    ...
    models = {
        ...
        u'forum.forumpost': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "u'forumposts'", 'blank': 'True', 'to': u"orm['blog.BlogCategory']"}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'forumposts'", 'to': u"orm['auth.User']"})
        },
        u'sites.site': {
